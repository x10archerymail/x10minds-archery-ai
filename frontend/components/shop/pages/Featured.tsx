...
import { Search, ShoppingCart, Star, Award } from "lucide-react";
    ...
    <div className="pt-32 pb-24 container mx-auto px-6">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8 mb-16">
        <div>
          <header className="mb-4">
            ...
            >
              Elite <span className="text-[var(--accent)]">Selection</span>
            </h1>
            <p
              className={`font-black uppercase tracking-[0.2em] text-[10px] ${isDark ? "text-gray-500" : "text-gray-400"}`}
            >
              The highest tier of performance equipment curated for
              professionals
            </p>
          </header>
        </div>
            ...
            <div
              className={`rounded-[2.5rem] p-6 h-full flex flex-col transition-all duration-500 border relative ${
                isDark
                  ...
                  : "bg-white border-gray-100 hover:border-[var(--accent)] hover:z-50 hover:shadow-2xl hover:shadow-gray-200"
              }`}
            >
              <div className="absolute top-6 left-6 z-10">
                <span
                  className={`bg-[var(--accent)] ${accentColor === "orange" || accentColor === "#FFD700" ? "text-black" : "text-white"} text-[9px] font-black uppercase tracking-widest px-4 py-1.5 rounded-full flex items-center gap-2 shadow-lg shadow-[rgba(var(--accent-rgb),0.2)]`}
                >
              ...
              >
                ...
                <div className="absolute bottom-6 right-6 translate-y-12 opacity-0 group-hover/img:translate-y-0 group-hover/img:opacity-100 transition-all duration-500 ease-out z-[60]">
                  <button
                    ...
                    className={`w-12 h-12 bg-[var(--accent)] ${accentColor === "orange" || accentColor === "#FFD700" ? "text-black" : "text-white"} rounded-2xl flex items-center justify-center shadow-xl shadow-[rgba(var(--accent-rgb),0.3)] transform hover:scale-110 active:scale-95 transition-all`}
                  >
      ...
      {filteredProducts.length === 0 && (
        <div className="py-32 text-center">
          ...
          >
            No elite gear found matching your search parameters.
          </p>
          <button
